...
loaded_model = joblib.load('models/rfmodel.joblib')
...
def predict():
    try:
        ...
        return render_template('index.html', crop_dict=crop_dict, season_dict=season_dict, state_dict=state_dict, result=result[0], crop_name=crop_name)
